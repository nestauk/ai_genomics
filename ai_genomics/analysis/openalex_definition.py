...
if __name__ == "__main__":
    ...
    works_meta = work_metadata("artificial_intelligence", list(range(2007, 2022)))
    concepts = work_concepts(
        "artificial_intelligence", "concepts", year_list=list(range(2007, 2022))
    )
    abstracts = work_abstracts("artificial_intelligence", years=list(range(2007, 2022)))
    ...
    all_works = work_metadata("artificial_intelligence", range(2007, 2022))
    all_concepts = work_concepts(
        "artificial_intelligence", "concepts", range(2007, 2022)
    )
    all_ai_mesh = work_concepts("artificial_intelligence", "mesh", range(2007, 2022))
    all_abstracts = work_abstracts("artificial_intelligence", range(2007, 2022))
