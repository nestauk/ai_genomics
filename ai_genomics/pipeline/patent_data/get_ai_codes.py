...
exact match and manual pruning/adding then later validation.
...
def get_classification_codes(
    ...
    Args:
        ...
        bad_genomics_codes: List of 'bad' ai patent classification codes
            of a given classification system
...
if __name__ == "__main__":
    ...
    validated_genomics_cpc_codes_df = load_s3_data(bucket_name, 'inputs/patent_data/validated_cpc_codes.csv')
    validated_genomics_cpc_codes_df['Code'] = validated_genomics_cpc_codes_df.Code.str.replace("\n", "")
    ...
    #add validated
    cpc_codes['genomics'] = validated_genomics_cpc_codes_df.set_index('Code')['Name'].T.to_dict()
